...
if PY3:
    ...
    bytes_type = str
log = logging.getLogger('flask_permissions')

__all__ = ('PermissionsRemote',)
...
class PermissionsRemote(object):
    def __init__(
        self,
        permission_url=None,
        encoding='utf-8',
    ...
    def check_permission(self, actor, application, permissions_id):
        data = {
            'actor': actor,
    ...
    def check_role(self, actor, resource_type, tenant_id, role_tenant=None):
        data = {
            'actor': actor,
            'type': resource_type,
            'tenant_id': tenant_id,
